...
public class DateTimeFormatter {
    public static void main(String s[]) {
        ...
        java.time.format.DateTimeFormatter newDateFormat = java.time.format.DateTimeFormatter.ofPattern(strDateFormat);
        ...
        // Create a DateTimeFormatter object using the user-provided format
        java.time.format.DateTimeFormatter newTimeFormat = java.time.format.DateTimeFormatter.ofPattern(strTimeFormat);
        ...
        // Create a DateTimeFormatter object using the user-provided format
        java.time.format.DateTimeFormatter newDateTimeFormat = java.time.format.DateTimeFormatter.ofPattern(strDateTimeFormat);
