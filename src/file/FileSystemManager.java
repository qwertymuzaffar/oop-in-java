...
public class FileSystemManager {
    ...
    private boolean processCommand(String command) {
        ...
        switch (commandName) {
            case "help":
                ...
                break;
            case "ls":
                // Implement listing files and directories
                listFiles();
                break;
            case "cd":
                // Implement changing directories
                // Hint: Handle "cd .." (parent directory) and "cd directoryName"
                changeDirectory(args);
                break;
            case "pwd":
                // Implement displaying current directory path
            ...
            case "rename":
                ...
                break;
            case "find":
                // Implement searching for files by name pattern
                if (args.isEmpty()) {
                ...
                break;
            case "info":
                // Implement displaying file information
                if (args.isEmpty()) {
                    System.out.println("Error: File name is required");
                } else {
    ...
    private void createFile(String fileName) {
        ...
        try {
            ...
            if (created) {
                System.out.println("File created: " + currentDirectory.getAbsolutePath() + "/" + fileName);
            } else {
    ...
    private void delete(String name) {
        // Implement deleting a file or directory
